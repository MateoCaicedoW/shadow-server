...
func newClient(conn *websocket.Conn, wsServer *WsServer, id uuid.UUID, name string) *Client {
	return &Client{
		ID:       id,
		Name:     name,
		conn:     conn,
...
func ServeWs(wsServer *WsServer, w http.ResponseWriter, r *http.Request) {
	...
	id := uuid.FromStringOrNil(r.URL.Query().Get("id"))
	if id.IsNil() {
	...
	client := newClient(conn, wsServer, id, name)
